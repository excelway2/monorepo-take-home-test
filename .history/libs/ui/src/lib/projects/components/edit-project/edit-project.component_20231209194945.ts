...
export class EditProjectComponent implements OnInit{
  ...
  checkExistanceOfOrder(): void {
    if (this.projectForm.valid) {
      ...
      // Fetch the specific project by ID to get its existing order
      this._editProjectService.getProjectById(updatedData.id).subscribe((project) => {
        if (project && project.order !== updatedData.order) {
