...
export class ProjectsComponent implements OnInit {
  ...
  onDrop(event: CdkDragDrop<Project[]>): void {
    if (!this.projects || !event || !event.previousIndex || !event.currentIndex ||
      ...
      console.error('Invalid indices or projects array');
      return;
    }
    ...
    this.projectsService
      .updateOrderBetweenProjects(projectId1, order1, projectId2, order2)
      .pipe(
        catchError((error) => {
